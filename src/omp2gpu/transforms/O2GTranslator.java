...
/*			if( defaultBlockSize < 64 ) {
		...
		if( value != null ) {
			...
			shrdArryCachingOnConstPrintCall.addArgument(new StringLiteral("====> Cache R/O shared arry variables onto GPU constant memory.\\n"));
			...
			if( !found_main ) {
				...
				if( found_main ) {
					...
					if( arglist.size() > 0 ) {
						...
						//not be inserted. For now, inserting this call is disabled. If user needed this//
						//call, insert it manually.                                                     //
						//////////////////////////////////////////////////////////////////////////////////
						/*
