// $ANTLR 2.7.7 (20100807): "NewCParser.g" -> "NewCLexer.java"$
...
public NewCLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("short", this), new Integer(22));
	...
	literals.put(new ANTLRHashString("typeof", this), new Integer(32));
	...
	literals.put(new ANTLRHashString("float", this), new Integer(25));
	...
	literals.put(new ANTLRHashString("_Imaginary", this), new Integer(31));
	...
	literals.put(new ANTLRHashString("_Complex", this), new Integer(30));
	literals.put(new ANTLRHashString("int", this), new Integer(23));
	...
	literals.put(new ANTLRHashString("_Bool", this), new Integer(29));
	...
	literals.put(new ANTLRHashString("long", this), new Integer(24));
